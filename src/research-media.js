...
export const researchMedia = {
  ...
  'club-america': publicAvatar('instagram', 'clubamerica', 'Club América official profile visual', 'Club América official account', 'https://www.instagram.com/clubamerica/'),
  'chivas-guadalajara': publicAvatar('instagram', 'chivas', 'Chivas official profile visual', 'Chivas official account', 'https://www.instagram.com/chivas/'),
  ...
  'river-plate': publicAvatar('instagram', 'riverplate', 'River Plate official profile visual', 'River Plate official account', 'https://www.instagram.com/riverplate/'),
  'conmebol-libertadores': publicAvatar('instagram', 'libertadores', 'CONMEBOL Libertadores official profile visual', 'CONMEBOL Libertadores official account', 'https://www.instagram.com/libertadores/'),
  shakira: publicAvatar('instagram', 'shakira', 'Shakira official profile portrait', 'Shakira official account', 'https://www.instagram.com/shakira/'),
  'bad-bunny': publicAvatar('instagram', 'badbunnypr', 'Bad Bunny official profile portrait', 'Bad Bunny official account', 'https://www.instagram.com/badbunnypr/'),
  'karol-g': publicAvatar('instagram', 'karolg', 'Karol G official profile portrait', 'Karol G official account', 'https://www.instagram.com/karolg/'),
  'j-balvin': publicAvatar('instagram', 'jbalvin', 'J Balvin official profile portrait', 'J Balvin official account', 'https://www.instagram.com/jbalvin/'),
  bizarrap: publicAvatar('instagram', 'bizarrap', 'Bizarrap official profile portrait', 'Bizarrap official account', 'https://www.instagram.com/bizarrap/'),
  'mon-laferte': publicAvatar('instagram', 'monlaferte', 'Mon Laferte official profile portrait', 'Mon Laferte official account', 'https://www.instagram.com/monlaferte/'),
  'grupo-5': publicAvatar('instagram', 'elgrupo5oficial', 'Grupo 5 official profile visual', 'Grupo 5 official account', 'https://www.instagram.com/elgrupo5oficial/'),
  ...
  werevertumorro: publicAvatar('instagram', 'werevertumorro', 'Werevertumorro official profile portrait', 'Werevertumorro official account', 'https://www.instagram.com/werevertumorro/'),
  'davoo-xeneize': publicAvatar('instagram', 'davooxeneize', 'Davoo Xeneize official profile portrait', 'Davoo Xeneize official account', 'https://www.instagram.com/davooxeneize/'),
  'jero-freixas': publicAvatar('instagram', 'jerofreixas', 'Jero Freixas official profile portrait', 'Jero Freixas official account', 'https://www.instagram.com/jerofreixas/'),
  ...
  'pablo-giralt': publicAvatar('instagram', 'pablogiralt', 'Pablo Giralt official profile portrait', 'Pablo Giralt official account', 'https://www.instagram.com/pablogiralt/'),
  'juan-guarnizo': publicAvatar('instagram', 'juansguarnizo', 'Juan Guarnizo official profile portrait', 'Juan Guarnizo official account', 'https://www.instagram.com/juansguarnizo/'),
  'la-cobra': publicAvatar('instagram', 'lautarodelcampo', 'La Cobra official profile portrait', 'La Cobra official account', 'https://www.instagram.com/lautarodelcampo/'),
  moluscotv: publicAvatar('youtube', 'MoluscoTV', 'MoluscoTV official channel visual', 'MoluscoTV official channel', 'https://www.youtube.com/@MoluscoTV'),
  'chente-ydrach': publicAvatar('instagram', 'chenteydrach', 'Chente Ydrach official profile portrait', 'Chente Ydrach official account', 'https://www.instagram.com/chenteydrach/'),
  alofoke: publicAvatar('instagram', 'alofokeradiofm', 'Alofoke Radio Show official profile visual', 'Alofoke official account', 'https://www.instagram.com/alofokeradiofm/'),
  ...
  'la-divaza': publicAvatar('instagram', 'ladivaza', 'La Divaza official profile portrait', 'La Divaza official account', 'https://www.instagram.com/ladivaza/'),
  'calle-y-poche': publicAvatar('instagram', 'calleypoche', 'Calle y Poché official profile portrait', 'Calle y Poché official account', 'https://www.instagram.com/calleypoche/'),
  ...
  'kenia-os': publicAvatar('instagram', 'keniaos', 'Kenia OS official profile portrait', 'Kenia OS official account', 'https://www.instagram.com/keniaos/'),
