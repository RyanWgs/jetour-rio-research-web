...
const copy = {
  zh: {
    title: '11月里约资源调研',
    lede: '聚焦整个 2026 年 11 月：可借势活动、项目场地与酒店配套，并收录巴西沙滩音乐节案例及异业合作资源。',
  ...
  en: {
    ...
    lede: 'A planning library for November 2026: Rio events, venues and hotels, Brazilian beach-festival cases, plus partnership, IP and communication resources.',
...
function LanguageGate({ onSelect }: { onSelect: (locale: Locale) => void }) {
  return <main className="language-gate">
    ...
    <div className="language-options">
      <button type="button" onClick={() => onSelect('zh')}><span>01</span><strong>中文版</strong><small>五个资源模块</small><i>进入 ↗</i></button>
      <button type="button" onClick={() => onSelect('en')}><span>02</span><strong>English Version</strong><small>Seven resource modules</small><i>Enter ↗</i></button>
    </div>
